...
(()=>{
    ...
    !function(o) {
        ...
        o(document).on("click", ".fullscreen-button", (function() {
            ...
            void 0 !== document.fullScreenElement && null === document.fullScreenElement || void 0 !== document.msFullscreenElement && null === document.msFullscreenElement || void 0 !== document.mozFullScreen && !document.mozFullScreen || void 0 !== document.webkitIsFullScreen && !document.webkitIsFullScreen ? document.documentElement.requestFullScreen ? document.documentElement.requestFullScreen() : document.documentElement.mozRequestFullScreen ? document.documentElement.mozRequestFullScreen() : document.documentElement.webkitRequestFullScreen ? document.documentElement.webkitRequestFullScreen(Element.ALLOW_KEYBOARD_INPUT) : document.documentElement.msRequestFullscreen && document.documentElement.msRequestFullscreen() : (o("html").removeClass("fullscreen-content"),
        ...
        o(document).on("click", "[data-toggle='search']", (function(e) {
            var r = o("body");
            r.hasClass("search-gone") ? (r.addClass("search-gone"),
            r.removeClass("search-show")) : (r.removeClass("search-gone"),
            r.addClass("search-show"))
        }
        ));
        var r = function() {
            o(window).outerWidth() <= 1024 ? (o("body").addClass("sidebar-gone"),
            o(document).off("click", "body").on("click", "body", (function(e) {
                (o(e.target).hasClass("sidebar-show") || o(e.target).hasClass("search-show")) && (o("body").removeClass("sidebar-show"),
        ...
        o('[data-toggle="card-remove"]').on("click", (function(e) {
            return o(this).closest(a).remove(),
            e.preventDefault(),
            !1
        }
        )),
        o('[data-toggle="card-collapse"]').on("click", (function(e) {
            return o(this).closest(a).toggleClass("card-collapsed"),
            e.preventDefault(),
            !1
        }
        )),
        o('[data-toggle="card-fullscreen"]').on("click", (function(e) {
            return o(this).closest(a).toggleClass("card-fullscreen").removeClass("card-collapsed"),
            e.preventDefault(),
            !1
        }
        )),
        ...
        o(".thumb").on("click", (function() {
            o(this).hasClass("active") || (o(".thumb.active").removeClass("active"),
            o(this).addClass("active"))
        }
        )),
        o("#background-left1").on("click", (function() {
            return o("body").addClass("light-mode"),
        ...
        o("#background-left2").on("click", (function() {
            return o("body").addClass("dark-mode"),
        ...
        o("#background1").on("click", (function() {
            return o("body").addClass("light-header"),
            o("body").removeClass("color-header"),
            o("body").removeClass("dark-header"),
            o("body").removeClass("gradient-header"),
            !1
        ...
        o("#background2").on("click", (function() {
            return o("body").addClass("color-header"),
            o("body").removeClass("light-header"),
            o("body").removeClass("dark-header"),
            o("body").removeClass("gradient-header"),
            !1
        ...
        o("#background3").on("click", (function() {
            return o("body").addClass("dark-header"),
            o("body").removeClass("color-header"),
            o("body").removeClass("light-header"),
            o("body").removeClass("gradient-header"),
            !1
        ...
        o("#background11").on("click", (function() {
            return o("body").addClass("gradient-header"),
            o("body").removeClass("dark-header"),
            o("body").removeClass("color-header"),
            o("body").removeClass("light-header"),
            !1
        ...
        o("#background4").on("click", (function() {
            return o("body").addClass("light-menu"),
            o("body").removeClass("color-menu"),
            o("body").removeClass("dark-menu"),
            o("body").removeClass("gradient-menu"),
            o("body").removeClass("light-hormenu"),
        ...
        o("#background5").on("click", (function() {
            return o("body").addClass("color-menu"),
            o("body").removeClass("light-menu"),
            o("body").removeClass("dark-menu"),
            o("body").removeClass("gradient-menu"),
            o("body").removeClass("light-hormenu"),
        ...
        o("#background6").on("click", (function() {
            return o("body").addClass("dark-menu"),
            o("body").removeClass("color-menu"),
            o("body").removeClass("light-menu"),
            o("body").removeClass("gradient-menu"),
            o("body").removeClass("light-hormenu"),
        ...
        o("#background10").on("click", (function() {
            return o("body").addClass("gradient-menu"),
            o("body").removeClass("color-menu"),
            o("body").removeClass("light-menu"),
            o("body").removeClass("dark-menu"),
            o("body").removeClass("light-hormenu"),
        ...
        o("#background7").on("click", (function() {
            return o("body").addClass("light-hormenu"),
            o("body").removeClass("color-hormenu"),
            o("body").removeClass("dark-hormenu"),
            o("body").removeClass("gradient-hormenu"),
            o("body").removeClass("dark-menu"),
        ...
        o("#background8").on("click", (function() {
            return o("body").addClass("color-hormenu"),
            o("body").removeClass("light-hormenu"),
            o("body").removeClass("dark-hormenu"),
            o("body").removeClass("gradient-hormenu"),
            o("body").removeClass("dark-menu"),
        ...
        o("#background9").on("click", (function() {
            return o("body").addClass("dark-hormenu"),
            o("body").removeClass("color-hormenu"),
            o("body").removeClass("light-hormenu"),
            o("body").removeClass("gradient-hormenu"),
            o("body").removeClass("dark-menu"),
        ...
        o("#background13").on("click", (function() {
            return o("body").addClass("gradient-hormenu"),
            o("body").removeClass("dark-hormenu"),
            o("body").removeClass("color-hormenu"),
            o("body").removeClass("light-hormenu"),
            o("body").removeClass("dark-menu"),
