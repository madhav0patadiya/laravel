    ...
    <div class="container">
        <div class="account-wrapper">
            ...
            @else
                ...
                @endif
            @endif
            <form class="account-form" method="post" id="register-form" action="{{ agent_url('commit-register') }}">
                @csrf
            ...
            <div class="account-bottom">
                <span class="d-block cate pt-10">Are you a Agent? <a href="{{ agent_url() }}">Login</a></span>
            </div>
        </div>
    </div>
</div>
