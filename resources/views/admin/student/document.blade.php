...
<div class="page-header d-xl-flex d-block">
    ...
    <div class="page-rightheader ml-md-auto">
        <div class="align-items-end flex-wrap my-auto right-content breadcrumb-right">
            <div class="btn-list">
                <a href="{{ admin_url('students') }}" class="btn btn-primary mr-3">View Students</a>
            </div>
        </div>
    </div>
</div>
...
<section class="">
    @if (isset($student->id))
        ...
        <div class="col-12">
            <div class="dropzone_container" data-url="{{ admin_url('students/document-upload/' . encreptIt($student->id)) }}"></div>
        </div>
