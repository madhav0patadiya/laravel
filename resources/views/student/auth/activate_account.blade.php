        ...
        <div class="row">
            <div class="col-12">
                <div class="pageheader-content text-center">
                    <h2>Student Activate Account Page</h2>
...
<div class="login-section padding-tb section-bg">
    <div class="container">
        <div class="account-wrapper">
            <h3 class="title">Activate Account for Student</h3>
            ...
            @else
                ...
                @endif
            @endif
            <form class="account-form" method="post" id="reset-form"  action="{{ student_url('activate-account') }}">
                @csrf
            ...
            <div class="account-bottom">
                <span class="d-block cate pt-10">Back to Login? <a href="{{ student_url() }}">Login</a></span>
            </div>
        </div>
    </div>
</div>
