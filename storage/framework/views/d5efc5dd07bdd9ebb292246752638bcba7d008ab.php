        ...
        <div class="row">
            <div class="col-12">
                <div class="pageheader-content text-center">
                    <h2>Agent Activate Account Page</h2>
...
<div class="login-section padding-tb section-bg">
    <div class="container">
        <div class="account-wrapper">
            <h3 class="title">Activate Account for Agent</h3>
            ...
            <?php else: ?>
                ...
                <?php endif; ?>
            <?php endif; ?>
            <form class="account-form" method="post" id="reset-form"  action="<?php echo e(agent_url('activate-account')); ?>">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('web.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\people_led\resources\views/front/auth/activate_account.blade.php ENDPATH**/ ?>