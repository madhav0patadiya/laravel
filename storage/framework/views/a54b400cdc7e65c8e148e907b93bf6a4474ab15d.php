                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="phone" placeholder="Number" value="<?php echo e(isset($login_user->phone) ? $login_user->phone : ''); ?>">
                                </div>
                            </div>
                            <!-- <div class="col-sm-6 col-md-6">
                                <div class="form-group">
...
<?php echo $__env->make('front.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\glscholars\resources\views/front/profile/setup.blade.php ENDPATH**/ ?>