                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="phone" placeholder="Phone" value="<?php echo e(isset($student->phone) ? $student->phone : ''); ?>">
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Citizenship<small class="mandotory">*</small></label>
                                    <input type="text" class="form-control" name="citizenship" placeholder="Citizenship" value="<?php echo e(isset($student->citizenship) ? $student->citizenship : ''); ?>">
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Course<small class="mandotory">*</small></label>
                                    <input type="text" class="form-control" name="course" placeholder="Course" value="<?php echo e(isset($student->course) ? $student->course : ''); ?>">
                                </div>
                            </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\glscholars\resources\views/admin/student/setup.blade.php ENDPATH**/ ?>