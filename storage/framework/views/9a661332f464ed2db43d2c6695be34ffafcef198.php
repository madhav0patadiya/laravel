            ...
            <tr>
                <td valign="top" width="100%">
                    <table align="center" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td width="100%">
                                <table class="table_scale" width="600" bgcolor="#017FB2" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                                        ...
                                                        <table class="full" align="left" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                                                            ...
                                                            <tr>
                                                                <td class="center" align="justify" style="padding-bottom: 10px; text-align: justify; font-weight: 300;font-family: 'Open Sans', Helvetica, Arial, sans-serif; color:#757f83; font-size:18px; line-height:34px; mso-line-height-rule: exactly;">
                                                                    You are receiving this email as you have requested to change your password on your <b><?php echo e(env('APP_NAME')); ?></b> account.
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="center" align="justify" style="padding-bottom: 10px; text-align: justify; font-weight: 300;font-family: 'Open Sans', Helvetica, Arial, sans-serif; color:#757f83; font-size:18px; line-height:34px; mso-line-height-rule: exactly;">
                                                                ...
                                                                <tr>
                                                                    <td class="center" align="center" style="margin: 0; padding-top: 10px; padding-bottom: 5px; font-weight:300; font-size:20px ; color:#017FB2; font-family: 'Open Sans', Helvetica, Arial, sans-serif; line-height: 30px;mso-line-height-rule: exactly;"> <span> <a href="<?php echo isset($link) ? $link : ''; ?>" target="_blank" style="font-weight: normal; font-style: 300; color:#017FB2; "> Reset Password Here </a>  </span> </td>
                                                                </tr>
                                                            </tr>
                                                            <tr>
                                                            </tr>
            ...
            <tr>
                <td align="center" valign="top" width="100%">
                    <table align="center" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td width="100%">
                                <table class="table_scale" width="600" bgcolor="#f5f7fa" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td width="100%">
                                            <table width="600" cellpadding="0" cellspacing="0" border="0">
                                                <tr>
                                                        ...
                                                        <table align="left" width="540" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                                                            <tr>
                                                                <td align="center" valign="top" style="padding: 0px;">
                                                                    <table border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#0079ff" style="margin: 0;">
                                                                        <tr>
                                                                            <td align="center" valign="middle" bgcolor="#f5f7fa" style="padding: 0px; font-size:13px ; font-style:normal; color:#adb2bb; font-family: 'Open Sans',Helvetica,Arial,sans-serif;line-height:0;"> <img class="img_scale" src="images/footer-radius.png" width="600" height="10" alt="" border="0" style="display:block;" /> </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            </tr>
...
</html><?php /**PATH D:\Xampp\htdocs\people_led\resources\views/front/email_templates/forget_password.blade.php ENDPATH**/ ?>