...
<?php if(isset($student_letter) && count($student_letter) > 0): ?>
<div class="gallery_container row">
    <?php $__currentLoopData = $student_letter; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
...
<?php echo $__env->make('student.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\glscholars\resources\views/student/profile/student_letter.blade.php ENDPATH**/ ?>