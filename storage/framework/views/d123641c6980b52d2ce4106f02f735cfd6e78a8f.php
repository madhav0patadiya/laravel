                        ...
                        <div class="course-item">
                            <div class="course-inner">
                                <div class="course-content">
                                    ...
                                    <p><?php echo $scholarship->overview ?? ''; ?></p>
                                    ...
                                    <p><?php echo $scholarship->paragraph_1 ?? ''; ?></p>
                                    <?php endif; ?>
                                    <?php if(isset($scholarship->paragraph_1)): ?>
                                    <p><?php echo $scholarship->paragraph_2 ?? ''; ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('web.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\glscholars\resources\views/web/home/scholarship.blade.php ENDPATH**/ ?>