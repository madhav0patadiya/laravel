    ...
    <header class="header-section">
                ...
                <div class="header-top-area">
                    ...
                    <ul class="lab-ul social-icons d-flex align-items-center">
                        ...
                        <?php if(isset(socialHandles()->twitter)): ?>
                            <li><a href="<?php echo e(socialHandles()->twitter ?? '#'); ?>" ><i class="icofont-linkedin"></i></a></li>
                        <?php endif; ?>
        ...
        <div class="menu d-lg-none">
            <ul class="lab-ul">
                ...
                <li><a href="<?php echo e(agent_url()); ?>">Agent Login</a></li>
                <li><a href="<?php echo e(student_url('')); ?>">Student Login</a></li>
            </ul>
        </div>
    </header>
    <!-- header section ending here -->
<?php /**PATH D:\Xampp\htdocs\glscholars\resources\views/web/layouts/header.blade.php ENDPATH**/ ?>