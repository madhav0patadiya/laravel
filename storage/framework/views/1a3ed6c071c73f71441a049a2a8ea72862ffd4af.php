            ...
            <div class="row align-items-center g-4">
                ...
                <div class="col-lg-6">
                    <div class="about-thumb">
                        <img src="<?php echo e($setting->image_path ?? ''); ?>" alt="Feedback Image" class="img-fluid rounded shadow">
                    </div>
                </div>
                <!-- Right Content -->
                <div class="col-lg-6">
                    <div class="about-content">
                        <h5 class="subtitle text-uppercase fw-medium"><?php echo e($setting->sec1_subtitle ?? ''); ?></h5>
                        <h2 class="title mb-3"><?php echo e($setting->sec1_heading ?? ''); ?></h2>
                        <p class="desc mb-3"><?php echo e($setting->sec1_para1 ?? ''); ?></p>
                        <p class="desc"><?php echo e($setting->sec1_para2 ?? ''); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="section-wrapper">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h5 class="subtitle text-uppercase fw-medium"><?php echo e($setting->sec2_subtitle ?? ''); ?></h5>
                    <h2 class="title mb-4"><?php echo e($setting->sec2_heading ?? ''); ?></h2>
                    <p class="desc mb-3"><?php echo e($setting->sec2_para1 ?? ''); ?></p>
                    <p class="desc"><?php echo e($setting->sec2_para2 ?? ''); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('web.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\glscholars\resources\views/web/home/index.blade.php ENDPATH**/ ?>