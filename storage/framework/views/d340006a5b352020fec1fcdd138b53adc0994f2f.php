                ...
                <form class="form" id="social-form" method="post" action="<?php echo e(admin_url('setting/commit-social-handles')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Twitter<small class="mandotory">*</small></label>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\people_led\resources\views/admin/setting/social_handles.blade.php ENDPATH**/ ?>