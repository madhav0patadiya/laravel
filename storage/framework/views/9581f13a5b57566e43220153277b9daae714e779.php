                                    ...
                                    <div class="content">
                                        <ul class="lab-ul">
                                            ...
                                            <?php if(isset(socialHandles()->twitter)): ?>
                                                <li><a href="<?php echo e(socialHandles()->twitter ?? '#'); ?>" target="_blank">LinkedIn</a></li>
                                            <?php endif; ?>
...
<!-- footer -->
<?php /**PATH D:\Xampp\htdocs\glscholars\resources\views/web/layouts/footer.blade.php ENDPATH**/ ?>