...
<body class="app sidebar-mini employee_portal" id="index1">
    ...
    <?php if(isset($js_files)): ?>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <?php endif; ?>
    <script src="<?php echo e(asset_url('js/front/modules/'.strtolower($controller).'.js')); ?>"></script>
...
<?php /**PATH D:\Xampp\htdocs\people_led\resources\views/front/layouts/master.blade.php ENDPATH**/ ?>