                ...
                <div class="col">
                    <div class="about-left">
                        <div class="about-thumb">
                            <img src="<?php echo e(asset_url('images/about/01.jpg')); ?>" alt="about">
                        </div>
                        <div class="abs-thumb">
                            <img src="<?php echo e(asset_url('images/about/02.jpg')); ?>" alt="about">
                        </div>
                            ...
                            <div class="instructor-item">
                                <div class="instructor-inner">
                                    <div class="instructor-thumb">
                                        <img src="<?php echo e($founder->image_path); ?>" alt="instructor">
                                    </div>
                                    <div class="instructor-content">
                                        <a href="team-single.html"><h4><?php echo e(ucfirst($founder->name) ?? ''); ?></h4></a>
                                        <p><?php echo e(ucfirst($founder->title) ?? ''); ?></p>
                                        <span class="ratting">
...
<?php echo $__env->make('web.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\glscholars\resources\views/web/home/about_us.blade.php ENDPATH**/ ?>