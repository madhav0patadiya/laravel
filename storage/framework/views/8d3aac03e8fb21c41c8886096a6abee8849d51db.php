    ...
    <div class="container">
        <div class="account-wrapper">
            ...
            <?php else: ?>
                ...
                <?php endif; ?>
            <?php endif; ?>            
            <form class="account-form" method="post" id="login-form" name="login" action="<?php echo e(student_url('login')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    <div class="d-flex justify-content-end flex-wrap pt-sm-2">
                        <a href="<?php echo e(student_url('forgot-password')); ?>">Forget Password?</a>
                    </div>
                </div>
            ...
            <div class="account-bottom">
                <span class="d-block cate pt-10">Don’t Have any Account?  <a href="<?php echo e(student_url('register')); ?>">Register</a></span>
            </div>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('web.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\people_led\resources\views/student/auth/login.blade.php ENDPATH**/ ?>