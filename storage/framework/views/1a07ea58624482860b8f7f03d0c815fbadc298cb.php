...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-xl-8 col-lg-7">
            <div class="card">
                <form class="form" id="profile-form" method="post" name="update_profile" action="<?php echo e(admin_url('profile/update-profile')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="user_id" class="user_id" value="<?php echo e(isset($login_user->id) && $login_user->id != ''? encreptIt($login_user->id) : ''); ?> "/>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="dropify" name="avatar" data-default-file="<?php echo e($login_user->avatar_path); ?>" data-height="180" />
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card">
                ...
                <form class="form" id="password-form" method="post" action="<?php echo e(admin_url('profile/update-password')); ?>">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="user_id" value="<?php echo e(isset($login_user->id) && $login_user->id != ''? encreptIt($login_user->id) : ''); ?> "/>
                    <div class="card-body">
                        <div class="form-group">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\people_led\resources\views/admin/profile/setup.blade.php ENDPATH**/ ?>