    ...
    <div class="container">
        <div class="account-wrapper">
            ...
            <?php else: ?>
                ...
                <?php endif; ?>
            <?php endif; ?>
            <form class="account-form" method="post" id="reset-form"  action="<?php echo e(student_url('activate-account')); ?>">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('web.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\people_led\resources\views/student/auth/activate_account.blade.php ENDPATH**/ ?>