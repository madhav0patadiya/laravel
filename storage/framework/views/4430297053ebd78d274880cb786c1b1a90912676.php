                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="overview"><?php echo e(isset($scholarship->overview) ? $scholarship->overview : ''); ?></textarea>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12">
                                <h3>Description:</h3>
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="paragraph_1"><?php echo e(isset($scholarship->paragraph_1) ? $scholarship->paragraph_1 : ''); ?></textarea>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group">
                                    <label class="form-label">Paragraph 2</label>
                                    <textarea class="form-control" name="paragraph_2"><?php echo e(isset($scholarship->paragraph_2) ? $scholarship->paragraph_2 : ''); ?></textarea>
                                </div>
                            </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\people_led\resources\views/admin/setting/setup_scholarship.blade.php ENDPATH**/ ?>