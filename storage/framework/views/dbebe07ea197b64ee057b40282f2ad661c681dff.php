        ...
        <div class="row">
            <div class="col-12">
                <div class="pageheader-content text-center">
                    <h2>Student Reset Password Page</h2>
...
<div class="login-section padding-tb section-bg">
    <div class="container">
        <div class="account-wrapper">
            <h3 class="title">Reset Password for Student</h3>
            ...
            <?php else: ?>
                ...
                <?php endif; ?>
            <?php endif; ?>
            <form class="account-form" method="post" id="reset-form"  action="<?php echo e(student_url('reset-password')); ?>">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('web.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\people_led\resources\views/student/auth/reset_password.blade.php ENDPATH**/ ?>